...
def re1():
    ...
    Button(Sara, text='Submit', width=20, bg='brown', fg='white',command = mo1).place(x=180, y=380)
...
def re2():
    ...
    label_5.place(x=30, y=330)
    Button(Ghadeer, text='Submit', width=20, bg='brown', fg='white',command = mo2).place(x=180, y=380)
...
def re3():
    ...
    label_5.place(x=30, y=330)
    Button(Afaf, text='Submit', width=20, bg='brown', fg='white',command = mo3).place(x=180, y=380)
...
#SQL
def data_add():
    sql = "INSERT INTO customer (name, email, movie) VALUES ('{name}', '{email}', '{movie}');"
